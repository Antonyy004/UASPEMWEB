<?php
session_start(); // Pastikan ini ada di atas halaman
include 'db.php';
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <div class="icon">
                <i style="color: aliceblue;" class="ion ion-bag"></i>
              </div>
              <a style="background-color: #33334d;" href="addproduct.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <div class="icon">
                <i style="color: aliceblue;" class="ion ion-stats-bars"></i>
              </div>
              <a style="background-color: #33334d;" href="feedback_replies.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              ...
              <a style="background-color: #33334d;" href="admin_crud.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
